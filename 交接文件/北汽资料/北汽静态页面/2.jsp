			...
			<form id="formData">
				<ul id="sortable">
					<li class="con-li ui-state-default" ><span>搜索</span> 
						<input type="text" value="" onkeyup="searchs()"  name="sousuo"  id="sousuo" style="margin-left:40px;cursor:pointer"  > 
					...
					<!-- <li class="con-li ui-state-default" ><span>车企</span>  -->
					 <li class="con-li ui-state-default" ><span>品牌</span>
						<input type="text" value="请选择" onclick="carname();"  readonly="readonly" style="margin-left:40px;cursor:pointer" name="car_name" id="car_name"> <span><a href="javascript:void(0)" onclick="clearcar()">清空</a> </span>
					</li>
					
					<!-- <li class="con-li ui-state-default" ><span>品牌</span>  -->
					<li class="con-li ui-state-default" ><span>车企</span> 
						<input type="text" value="请选择"  readonly="readonly" style="margin-left:40px;cursor:pointer" name="car_brand" id="car_brand"> 
					</li>
					<li class="con-li ui-state-default" ><span>车型</span> 
						<input type="text" value="请选择"  readonly="readonly" style="margin-left:40px;cursor:pointer;" name="car_type" id="car_type"> 
					</li>
					...
					<li class="con-li ui-state-default">
						<span>提及率</span>
						<input type="text" value="请输入主题词" name="keyword" id="keyword" style="margin-left:24px"/>
					</li>
					<li class="con-li ui-state-default">
						<span>满意度&nbsp;</span>
							<img class="con-biao" src="images/selectbiao.png"><select id="satisfy" name="satisfy" onclick="$(this).focus();">
					...
					<li class="con-li ui-state-default">
						...
						src="${pageContext.request.contextPath}/cms/js/calendar/skin/datePicker.gif" style="width:140px;margin-left:24px;cursor:pointer;"/> 到 <input type="text" name="endTime" id="endTime" value="<%=endTime%>" class="Wdate"  onclick="WdatePicker()"
						src="${pageContext.request.contextPath}/cms/js/My97DatePicker/skin/datePicker.gif" style="width:140px;margin-left:0;cursor:pointer;"/>				
					</li>
					<li class="con-li ui-state-default"  >
						<span>聚合&nbsp;</span>
							<img class="con-biao" src="images/selectbiao.png" style="margin-left:24px"><select id="polymerize" name="polymerize" onclick="$(this).focus();">
			                	<option value="" selected="">请选择</option>
